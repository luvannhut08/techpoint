        ...
        <div class="rounded-lg relative">
            ...
            <ModalBody class="modal-xl">
                <transition mode="out-in" name="fade">
                    <div>
                        <div class="flex mb-5">
                            <div class="w-1/3 font-bold text-base align-baseline text-orange-800">Tên nhóm tiêu chí</div>
                            <div class="w-2/3">
                                <input
                                  v-model.trim="groupName"
                                  class="form-control mb-2 pt-2 pb-2 pl-3"
                                  placeholder="Nhập tên nhóm tiêu chí"
                                />
                            </div>
                        </div>
                        <div class="flex align-center justify-center mb-4">
                            <div class="w-1/3 font-bold text-base align-baseline text-orange-800">Các thành viên đánh giá</div>
                            <div class="w-2/3">
                                <AvatarMultipleSelect
                                  ref="avatarMultipleSelect"
                ...
                <div class="flex justify-center mt-4 mb-4">
                    <button
                      class="px-4 py-2 bg-gray-500 hover:bg-gray-400 text-white rounded-lg mr-2 w-24"
                      @click="closeModalHandler"
                    >
                        Hủy
                    </button>
                    <button
                      class="px-4 py-2 bg-orange-700 hover:bg-orange-500 text-white rounded-lg w-24"
                      @click="createGroup"
                    >
                        Lưu
                    </button>
